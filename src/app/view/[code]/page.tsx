    ...
    return (
        <>
            <div className="petal-field">
                {[...Array(themeConfig.petalCount)].map((_, i) => (
                    <div
                        key={`petal-${i}`}
                    ...
                    >
                        {themeConfig.petals[Math.floor(Math.random() * themeConfig.petals.length)]}
                    </div>
                ))}
            </div>
            ...
            {unlocked && (
                <div id="experience" style={{ display: 'flex' }}>
                    ...
                    <section id="scene1">
                        <div className="scene1-particles">
                            {[...Array(30)].map((_, i) => {
                                ...
                                return (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            width: size,
                                            height: size,
                                            background: `${themeConfig.particleColor}${0.5 + Math.random() * 0.4})`,
